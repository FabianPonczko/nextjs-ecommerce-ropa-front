      ...
      <Center>
        <ColWrapper>
          ...
          <div>
            ...
            <div style={{marginTop:"120px",height:"30px",display:"flex",alignItems:"center",gap:"20px"}}>
              <svg  width={"40px"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
